...
def main():
    p1, subbids, encoding, npsych, meanmotion, behav = cimaqstart()
    os.makedirs(ndir, exist_ok=True)
    subbids.to_csv(join(ndir, 'subjects_bids.tsv'), sep='\t')
    memotask.to_csv(join(ndir, 'subjects_memorytask.tsv'), sep='\t')
...
# p1 = cimaqstart()
# display(p1, subbids, encoding, npsych, meanmotion, behav)
